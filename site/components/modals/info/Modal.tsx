...
const PRIZEFAQ = [
  {
    ...
    answer:
      "Work on a technical project that challenges you for each stage, track your time with Hackatime, and submit it. We (a team of teen coders like you!) will review it — approved projects earn artifacts!",
  },
  {
    question: "How many artifacts does each prize cost?",
    answer:
      "Think of it like an arcade! For every approved hour you log, you get 1 artifact to 'spend' on prizes (only for original projects — not pre-existing YSWS projects, which are part of Hack Club’s 'You Ship, We Ship' series where you build something and get rewarded).",
  },
  {
    question: "What's the final prize?",
    answer:
      "Complete 3 original projects and log 30 approved coding hours, and you can win a fully-covered flight (depending on where you're from) to a NYC hackathon for Athena Award alumni. Hack Club has hosted dozens of hackathons like these before — covered travel, stay, food — all of it.",
  },
  {
...
export default function InfoModal() {
  ...
  return (
    <Modal
      customHeader={{ icon: "person", heading: "Info" }}
      uxEventName="info"
      uxEvent={uxEvent}
    ...
    >
      <div className="flex flex-col gap-3">
        <Action title="Question not answered here?">
          Send a message in the{" "}
          <a href="https://app.slack.com/client/T0266FRGM/C06T17NQB0B">
            #athena-award
          </a>{" "}
          channel on the Hack Club Slack to get help.
        </Action>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <div className="col-span-1">
              <p>
                ...
                is what we use to track how much time you spend coding on your
              ...
              <ul className="list-decimal list-inside py-2">
                ...
                <li>
                  Install the Wakatime code extension in your editor. For
                  example, if you use Vscode, you can install it from{" "}
                  <a
                    target="_blank"
                ...
                <li>
                  Type a bit in your code editor, then check Hackatime again to
                  see your data appear.
                </li>
              </ul>
              <p className="font-bold">
                Still confused? Watch these videos to see how to set it up.
              </p>
              <a href="https://www.youtube.com/watch?v=fX9tsiRvzhg">
                Windows set-up guide
              </a>{" "}
              |{" "}
              <a href="https://www.youtube.com/watch?v=QTwhJy7nT_w">
                Mac/Linux set-up guide
              </a>
            </div>
            <img
          ...
          <span>
            ...
            <p>
              ...
              over the world who love coding. Check out some of our{" "}
