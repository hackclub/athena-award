...
export default function Profile() {
    ...
    return (
        <>
        <Modal customClear = {() => setError("")} uxEvent={uxEvent} uxEventName="profile" setUXEvent={setUXEvent} className="md:grid md:grid-cols-3 max-md:flex max-md:flex-col-reverse">
