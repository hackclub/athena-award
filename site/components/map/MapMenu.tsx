...
import { UserModuleData, BaseModule } from "@/types/Pathways";
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: [1, 0], transition: { delay: 0.5, duration: 0.75 } }} className={`w-screen h-screen px-20 py-14 fixed overflow-y-scroll z-10 transition duration-700 backdrop-blur-xl ${baseModuleData.visuals.accents.primary}`}>
              ...
              <ProfileModal />
                ...
                <div className="col-span-full lg:col-span-2 text-white">
                  <motion.h2 variants={slidingUpVariant} transition={{ delay: 0.3 }} initial='hidden' animate='visible' className="text-5xl italic text-white">{module}</motion.h2>
                  
                  <motion.div key={`${module}-details`} variants={slidingUpVariant} transition={{ delay: 0.4 }} initial='hidden' animate='visible' className="">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit consequatur veritatis voluptatum, quo quidem unde sequi esse cumque labore quia deserunt non adipisci quos, inventore hic quibusdam provident! Nam, eaque.
                  </motion.div>
                  <div className = "my-5">
                    <h2 className="text-4xl italic text-white">Completion Rewards</h2>
                  ...
                  <div className = "my-5">
                    <h2 className="text-3xl italic">Ready to submit?</h2>
                ...
                <div className="col-span-full lg:col-span-2">
                  {/* TO DO: move this section on top of the image on smaller screens */}
