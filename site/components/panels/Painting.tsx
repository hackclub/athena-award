...
export default function Painting({image, children, className, showCaptionOnSmall=false}: {image: string, children: React.ReactNode, className?: string, showCaptionOnSmall?: boolean}){
    return (
