...
export default function Icons() {
    ...
    return (
      <>
        <div className = "p-1 bg-black/20 rounded-lg absolute z-50 right-8 top-8 sm:right-16 sm:top-16 mb-5 flex flex-col items-center gap-4 text-white">
          <button onClick={() => {
              setUXEvent("profile");
            }} id="profile">
              {/* <img src="" width={48} height={48} alt="Profile details" /> */}
              <span className="ml-auto size-8 md:size-10 rounded-full bg-cover bg-no-repeat bg-center block" style={{
