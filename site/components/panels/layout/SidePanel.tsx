          ...
          <div className="fixed inset-0 z-[2] overflow-x-clip">
            <div className="flex min-h-full items-center justify-end">
              <motion.div
                ...
                className={`h-screen transition-[width] max-md:w-[100vw] ${widePanel ? "md:w-[100vw]" : "md:w-[70vw]"} translate-x-0 overflow-hidden bg-hc-secondary text-left shadow-xl`}
                style={{}}
              >
                <SidePanelBackground>
                  <div className="p-14">
                    <div className="flex items-center gap-4 text-hc-primary">
                      <button
                        ...
                        onClick={() => setWidePanel(!widePanel)}
                      >
                        <span className="sr-only">expand panel</span>
                        <img
                          src="https://icons.hackclub.com/api/icons/hackclub-red/expand"
                          className="size-[52px]"
                          alt=""
                        />
                      </button>
