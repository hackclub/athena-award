    ...
    <AnimatePresence>
      {modalIsOpen && (
        ...
        >
          ...
          >
            <div
              className={`w-full h-[85vh] ${customHeader ? "flex flex-col" : "max-md:overflow-auto"} max-w-5xl transform bg-hc-primary-dull text-left align-middle shadow-xl transition-all p-8 gap-4 text-white ${className}`}
            >
              {customHeader ? (
                <>
                  <div className="self-start *:align-middle flex gap-3 w-full align-middle md:sticky">
                    <div className="*:align-middle w-full h-fit bg-black/25 p-2 rounded flex gap-4">
                      <img
                        src={`https://icons.hackclub.com/api/icons/hackclub-red/${customHeader.icon}`}
