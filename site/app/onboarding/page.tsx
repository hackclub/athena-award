...
const steps = [
    {
        ...
        "description": "Code three projects that challenge you. Things for school and work don't count!"
    },
    {
        "step": "2. Ship your projects ⛵",
        "description": "What's the point of making a project if no one else can use it? To 'ship' your project, open source it and create a working version of it that others online can try!"
    },
    {
                        ...
                        <div className="text-left pt-8 mx-auto items-center justify-center gap-4 w-full">
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ ease: 'easeOut', delay: 0.75 }} className = "md:grid md:grid-cols-3 gap-4">
                                <div className = "col-span-2 *:text-xl flex flex-col gap-10 justify-center">
                                    <p>lost? confused? don't know what to do? here are some things that could help!</p>
                                    <ul className = "list-inside list-decimal *:md:indent-10">
                                        ...
                                        <li>
                                            send an email to <span className = "bg-hc-primary-dull px-1">athena@hackclub.com</span>
                                        </li>
                                    </ul>
                                    <span>psst. you can always revisit this page from <a href =  {`${process.env.NEXT_PUBLIC_BASE_URL}/onboarding`} className = "bg-hc-primary-dull px-1 text-white">/onboarding</a> or your profile.</span>
                                ...
                                <div className = "*:mx-auto w-full text-center">
                                    ...
                                    <span className = "text-center italic">go forth and be hacky!</span>
                                </div>
                            </motion.div>
                        </div>
                    </>}
