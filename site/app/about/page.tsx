        ...
        <div className = "flex flex-col w-screen p-16 min-h-screen bg-hc-primary-dull bg-[url(/bg.svg)]">
          ...
          <div className = "py-4 *:text-white *:text-xl flex flex-col gap-4">
            ...
            <div className = "flex flex-row gap-4">
              <img className = "hidden md:inline w-48" src = "https://hc-cdn.hel1.your-objectstorage.com/s/v3/7b4d1a4b891fce753d13942487d0258bdd9ae77c_image.png"/>
              ...
              <div className = "*:text-lg *:md:text-xl">
                  ...
                  <ul className = "list-inside list-disc">
                      ...
                      <li>and <a href = "/#collaborators">numerous others</a></li>
                  </ul>
              </div>
            ...
            <div className = "grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className = "*:text-lg *:md:text-xl">
                <p>Sign up through the button on the right to access the Athena Award website, where you'll be able to:</p>
                <ul className = "list-inside list-disc">
            ...
            <div className = "*:border-[#E89368] *:rounded-lg *:border-2 grid grid-cols-1 *:h-full md:grid-cols-2 gap-4 justify-center *:bg-[#E89368]/30 *:p-4 items-center">
                <div>
                    <h1>Guided Track</h1>
                    <p>Complete the three workshops on web development, designed by the team behind the Athena Award - or submit a project completed from another summer program. </p>
                </div>
                <div>
                    <h1>Custom Track</h1>
                    <p>Code three of your own projects - for people who know how to code already and want to challenge themselves! Things for work and school don't count for the Athena Award!</p>
                </div>
            </div>

            <h2 className = "!text-3xl">How do I submit my projects?</h2>
            <p>Projects are submitted through the Athena Award portal, which you can access by logging in.</p>
            <p>Your project needs to meet some criteria before you submit.</p>
            <ul className = "list-disc list-inside">
                <li>Your project needs to be technical in some way, shape or form.</li>
                <li>Code needs to be open source. Use a website like <a target = "_blank" href = "https://github.com">GitHub</a> to publish your code. If you're unsure of how to do this, check out the guide on <a target="_blank" href = "https://tribute.athena.hackclub.com">Tribute</a>.</li>
                ...
                <li>It needs to be <span className = "text-gold">something original</span>, that's not for work or school.</li>
                <li>Make it <span className = "text-gold">portfolio-ready</span>! Is this project something that you'd be proud to show off to an employer or teacher?</li>
            </ul>
            ...
            <p>For Guided Track projects, each workshop has its own set amount of hours, and we'll also ask you to self-report hours.</p>
            <p>For Custom Track projects, we'll ask you to install Wakatime - an extension for your code editor that will let us track how long you spend making your projects.</p>
            ...
            <p>Artifacts are the currency of the Athena Award! For every project you submit that gets approved, you'll earn the equivalent number of hours you spent coding on it in <span className = "text-gold inline">artifacts <img className = "h-8 inline" src = "https://hc-cdn.hel1.your-objectstorage.com/s/v3/44e7d5c7ff189dc439c2bea7483ade38630a1ca5_image.png"/></span>.</p>
            <p>Once you're logged in on the Athena Award website, you can spend these <span className = "text-gold inline">artifacts <img className = "h-8 inline" src = "https://hc-cdn.hel1.your-objectstorage.com/s/v3/44e7d5c7ff189dc439c2bea7483ade38630a1ca5_image.png"/></span> on prizes in the Shop. Click on the icon in the top right corner to access the shop.</p>
            <h2 className = "!text-3xl">I still have more questions!</h2>
            <ul className = "list-inside list-disc">
              <li>If you're already in the Slack, ask in the <a target = "_blank" href = "https://app.slack.com/client/T0266FRGM/C06T17NQB0B">#athena-award</a> channel.</li>
              <li>Alternatively, send an email to <a target = "_blank" href = "mailto:athena@hackclub.com">athena@hackclub.com</a> and one of the team will reply to you.</li>
            </ul>
