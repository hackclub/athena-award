...
export default function About(){
    ...
    <>
        ...
        <div className = "flex flex-col w-screen pt-24 p-16 min-h-screen bg-hc-primary-dull bg-[url(/bg.svg)]">
          ...
          <div className = "py-4 *:text-white *:text-xl  flex flex-col gap-4">
            ...
            <p>Additionally, all successful recipients of the Athena Award will be sent a physical certificate </p>
            ...
            <h2 className = "!text-3xl">Okay, I'm sold. How can I start working on my project?</h2>
            ...
            <p>The first one, <a target = "_blank" href = "https://tribute.hackclub.com">Tribute</a>, will teach you how to make a basic website themed after something you like. By the end of the Beginner Track, you'll be prepared to start making some awesome webpages!</p>
            ...
            <h2 className = "!text-3xl">How do I submit my project?</h2>
